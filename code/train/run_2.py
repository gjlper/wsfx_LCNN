...
from code.models.LightCNN import LightCNN
from code.models.config import Config

from code.train.loader import batch_iter2_test,data_load2,batch_iter2
...
save_dir  = '../../result/set1/lightcnn'  #修改处
ckpath = '30-50-1'
tbpath = '30-50-1'
